...
export class LunchService {
  ...
  constructor(private http:HttpClient,private router: Router) {
   ...
   getLunchList<T>(paginationParams:PaginationParams):Observable<PaginatedResult<T>>{
    ...
    return this.getPaginatedResult(this.baseUrl + 'Lunch/ShowLunchList',params);
  }
...
addLunch(formValue:any=null)
{
  return this.http.post(this.baseUrl + 'Lunch/AddLunch',formValue);
