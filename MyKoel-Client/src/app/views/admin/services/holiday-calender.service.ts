...
export class HolidayCalenderService {
  ...
  HolidayCalenderList$=  new BehaviorSubject<any>([]);
  ...
  constructor(private http:HttpClient,private router: Router) {
   ...
   getHolidayCalenderList<T>(paginationParams:PaginationParams):Observable<PaginatedResult<T>>{
    ...
    return this.getPaginatedResult(this.baseUrl + 'HolidayCalender/HolidayCalendarList',params);
  }
...
getLocationList(Location='')
{
  ...
  return this.http.get<any>(this.baseUrl+'HolidayCalender/LocationList',{params});
}

//uploadHolidayCalender

uploadHolidayCalender(formValue:any=null)
{
  return this.http.post(this.baseUrl + 'HolidayCalender/UploadExcel',formValue);
